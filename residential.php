...
<body>
    <section id="hedr" class="residential_hedr">
        <?php require 'partials/nav.php'; ?>
        <section id="hedr_2">
            <div class="lnd_pg_txt">
                <h1>Residential Design And Architecture</h1>
            </div>
        </section>
        <section id="pg_cntnt">
                ...
                <div class="dnags">
                    <div class="dnags_mns">
                        <div class="dnags_main">
                            ...
                            <div class="dnags_ttl">
                                <h2><a href="deck_sunroom_design.php">Deck & Sunrooms</a></h2>
                            </div>
                            <p>
                                We have years of experience in deck and sunroom design.
                                Bring a bit of the outdoors into your home, or a bit of your home into the outdoors.
                                Our renders will help you make an educated and informed decision on the addition to your
                                home, as well as provide you with the required materials and cost estimates.
                            </p>
                        </div>
                    </div>
                    <div class="dnags_mns">
                        <div class="dnags_main">
                            ...
                            <div class="dnags_ttl">
                                <h2><a href="home_design.php">New Homes</a></h2>
                            </div>
                            <p>
                    ...
                    <div class="dnags_mns">
                        <div class="dnags_main">
                            ...
                            <div class="dnags_ttl">
                                <h2><a href="addition_renovations.php">Additions & Renovations</a></h2>
                            </div>
                            <p>
                                Whether you're looking to add an extra room, a loft, or a whole second floor, we're here for
                                you from start to finish. We can do everything from drafting different floor plans and ideas
                                to 3D modeling, as well as code reviews and official site plans.
                            </p>
                        </div>
                    </div>
                    <div class="dnags_mns">
                        <div class="dnags_main">
                            <img src="images/gab_svg.png">
                            <div class="dnags_ttl">
                                <h2><a href="garage_barn_design.php">Garage & Barns</a></h2>
                            </div>
                            <p>
                                Garages and Barns have more purposes than just storage. Many people use them as workshops,
                                social venues, or with attached guest accommodations.
                            </p>
                        </div>
                    </div>
                    <div class="dnags_mns">
                        <div class="dnags_main">
                            <img src="images/sd_svg.png">
                            <div class="dnags_ttl">
                                <h2><a href="javascript:void(0)">Septic Design</a></h2>
                            </div>
                            <p>
                                New or replacement septic designs.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="or_prjts">
            ...
            <section class="or_prjts_2">
                <div class="mn_prjts">
                    <img src="images/image_laptop (1).jpg">
                    <div class="prjt_nm">
                        <a href="home_design.php">
                            <h2>House</h2>
                            <h3>Rotterdam, NY</h3>
                        </a>
                    </div>
                ...
                <div class="mn_prjts">
                    <img src="images/image_laptop (2).jpg">
                    <div class="prjt_nm">
                        <a href="Javascript:void(0)">
                            <h2>Tri-Plex</h2>
                            <h3>Gluilderland, NY</h3>
                        </a>
                    </div>
                </div>
                <div class="mn_prjts">
                    <img src="images/image_laptop (3).jpg">
                    <div class="prjt_nm">
                        <a href="garage_barn_design.php">
                            <h2>Horse Barn</h2>
                            <h3>Fort Edward, NY</h3>
                        </a>
                    </div>
                </div>
                <div class="mn_prjts">
                    <img src="images/image_laptop (4).jpg">
                    <div class="prjt_nm">
                        <a href="deck_sunroom_design.php">
                            <h2>Covered Porch</h2>
                            <h3>Schenectady, NY</h3>
                        </a>
                    </div>
                </div>
                <div class="mn_prjts">
                    <img src="images/image_laptop (5).jpg">
                    <div class="prjt_nm">
                        <a href="garage_barn_design.php">
                            <h2>Garage</h2>
                            <h3>Corinth, NY</h3>
                ...
                <div class="mn_prjts">
                    <img src="images/image_laptop (6).jpg">
                    <div class="prjt_nm">
                        <a href="deck_sunroom_design.php">
                            <h2>Covered Deck</h2>
                            <h3>Ballston Lake, NY</h3>
                        </a>
                    </div>
                </div>
            </section>
        ...
        <section id="pg_cntnt">
            <section id="pg_cntnt_2">
                <div class="ltst_prjts" style="padding-top: 40px;padding-bottom: 40px;">
